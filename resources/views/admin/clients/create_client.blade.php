...
<html lang="pt-br">
	<head>
		...
		<title>Cadastro Usuario - MC</title>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Cadastro de Usuario</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Cadastro de Usuario</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-md-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Preencha os dados para cadastro de novo usuario</h6>
									</div>
									<div class="clearfix"></div>
								</div>
										...
										<div class="form-wrap mt-40">
											<form action="{{route('store_user')}}" method="POST">
                                                ...
                                                <div class="form-group">
													...
													<select class="form-control select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" required>
